<?php
/**
* Template Name: Projects New Page
* @package WordPress
*/
?>
  ...
  <?php
    ...
    while($project->have_posts()) {
      $project->the_post(); $counter++ ?>
        ...
        <?php $url = wp_get_attachment_image_url( get_post_thumbnail_id($post->ID), 'project_img_small' ); ?>
    ...
    <?php
      ...
      while($project->have_posts()) {
        $project->the_post(); $counter++ ?>
          ...
          <div class="search-section  <?php echo $counter; ?>">
            <div class="projectFeaturedImage" style="background-image:url(<?php echo $url ?>);"><p class="projectTitle"><?php the_title(); ?></p></div>
